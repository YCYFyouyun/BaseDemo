...
public class ImageLoaderOptions implements Cloneable {
    ...
    @ImageScaleType.Type
    private int scaleType = ImageScaleType.CENTER_CROP;
    ...
    public static final class Builder {
        ...
        public Builder scaleType(@ImageScaleType.Type int type) {
            options.setScaleType(type);
            return this;
        }
        ...
        public Builder newBuilder() {
            ...
            newBuilder.scaleType(options.getScaleType());
